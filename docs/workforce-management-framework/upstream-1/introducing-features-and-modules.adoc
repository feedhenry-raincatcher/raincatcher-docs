...
= {RainCatcher} Features

include::topics/con-keycloak.adoc[leveloffset=+1]
include::topics/con-introducing-securityfeatures.adoc[leveloffset=+1]

== Introducing {RainCatcher} Security Strategies
include::topics/con-passportauth-securitystrategy.adoc[leveloffset=+2]
For more information, see xref:defining-raincatcher-security-ref-passportauth-securitystrategy[Defining the Security Strategy for {RainCatcher} PassportAuth].

include::topics/con-keycloak-securitystrategy.adoc[leveloffset=+2]
For more information, see xref:defining-raincatcher-security-ref-keycloak-securitystrategy[Defining the Security Strategy for {RainCatcher} {Keycloak}].
