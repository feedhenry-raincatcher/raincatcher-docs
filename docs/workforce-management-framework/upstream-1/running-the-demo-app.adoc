...
The {WFM-RC-NameShort} demo app comprises of three applications *Mobile*, *Portal* and a *Node Server*.
Login gain access to the *Mobile* and *Portal* demo applications.
