...
. xref:run-keycloak-docker-image-{chapter}[Running the {WFM-RC-KeycloakName} Docker Image]
. xref:adding-keycloak-configuration-{chapter}[Importing the {WFM-RC-KeycloakName} Realm Settings]
. xref:adding-keycloak-configuration-{chapter}[Adding {WFM-RC-KeycloakName} Configuration]
. xref:enabling-keycloak-on-the-demo-server-{chapter}[Enabling {WFM-RC-KeycloakName} on the Demo Server]
. xref:logging-in-to-the-keycloak-admin-console-{chapter}[Logging in to the {WFM-RC-KeycloakName} Admin Console]
...
[id='run-keycloak-docker-image-{chapter}']
[discrete]
...
[id=adding-keycloak-configuration-{chapter}]
[discrete]
...
[id=enabling-keycloak-on-the-demo-server-{chapter}]
[discrete]
...
[id=logging-in-to-the-keycloak-admin-console-{chapter}]
[discrete]
