[id='{chapter}-pro-keycloak-enablement']
...
. xref:{chapter}-run-keycloak-docker-image[Running the {WFM-RC-KeycloakName} Docker Image]
. xref:{chapter}-adding-keycloak-configuration[Importing the {WFM-RC-KeycloakName} Realm Settings]
. xref:{chapter}-adding-keycloak-configuration[Adding {WFM-RC-KeycloakName} Configuration]
. xref:{chapter}-enabling-keycloak-on-the-demo-server[Enabling {WFM-RC-KeycloakName} on the Demo Server]
. xref:{chapter}-logging-in-to-the-keycloak-admin-console[Logging in to the {WFM-RC-KeycloakName} Admin Console]
...
[id='{chapter}-run-keycloak-docker-image']
[discrete]
...
[id={chapter}-adding-keycloak-configuration]
[discrete]
...
[id={chapter}-enabling-keycloak-on-the-demo-server]
[discrete]
...
[id={chapter}-logging-in-to-the-keycloak-admin-console]
[discrete]
