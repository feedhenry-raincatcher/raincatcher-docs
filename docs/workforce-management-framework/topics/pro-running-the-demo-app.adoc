...
. xref:{context}-running-the-mobile-and-portal-applications[Running the Mobile and Portal {WFM-RC-AppType2} Applications]
...
[discrete]
== Running the Mobile and Portal {WFM-RC-AppType2} Applications
