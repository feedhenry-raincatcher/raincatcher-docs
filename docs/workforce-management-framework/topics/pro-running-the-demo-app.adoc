[id='{chapter}-pro-running-the-demo-app']
= Introduction

This section includes:

. xref:{chapter}-cloning-the-git-repository[Cloning the Git Repository]
. xref:{chapter}-installing-angular-dependencies[Installing Angular Dependencies]
. xref:{chapter}-installing-core-dependencies[Installing Core Dependencies]
. xref:{chapter}-starting-mongodb-and-redis[Starting MongoDB and Redis]
. xref:{chapter}-starting-the-core-server[Starting the Core Server]
. xref:{chapter}-running-the-mobile-and-portal-demo-applications[Running the Mobile and Portal Demo Applications]
...
[id='{chapter}-cloning-the-git-repository']
[discrete]
...
[id='{chapter}-installing-angular-dependencies']
[discrete]
...
[id='{chapter}-installing-core-dependencies']
[discrete]
...
[id='{chapter}-starting-mongodb-and-redis']
[discrete]
...
[id='{chapter}-starting-the-core-server']
[discrete]
...
[id='{chapter}-running-the-mobile-and-portal-demo-applications']
[discrete]
...
For login details, refer to xref:{chapter}-credentials-for-the-demo-application[Credentials for the Demo Application] section of xref:{chapter}-ref-demo-app[{WFM-RC-NameShort} Demo Application Reference Material].
