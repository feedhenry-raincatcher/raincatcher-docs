[id='{chapter}-ref-introducing-raincatcher']
= {WFM-RC-NameShort} Reference Material

This section includes:

. xref:{chapter}-highlighting-raincatcher-areas-of-focus[Highlighting {WFM-RC-NameShort} Areas of Focus]
. xref:{chapter}-raincatcher-at-a-technical-level[{WFM-RC-NameShort} at a Technical Level]
. xref:{chapter}-identifying-raincatcher-repositories[Identifying {WFM-RC-NameShort} Repositories]
. xref:{chapter}-differentiating-raincatcher-from-tech-preview[Differentiating {WFM-RC-NameShort} from 'Tech Preview']

[id='{chapter}-highlighting-raincatcher-areas-of-focus']
...
[id='{chapter}-raincatcher-at-a-technical-level']
...
[id='{chapter}-identifying-raincatcher-repositories']
...
[id='{chapter}-differentiating-raincatcher-from-tech-preview']
