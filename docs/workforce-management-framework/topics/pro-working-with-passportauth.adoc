[id='{chapter}-pro-working-with-passportauth']
= Introduction

This section includes:

//. xref:{chapter}-disabling-passportauth[Disabling PassportAuth]
//. xref:{chapter}-enabling-passportauth[Enabling PassportAuth]
. xref:{chapter}-pointing-passportauth-to-a-datasource[Pointing PassportAuth to a Datasource]
...
//[id='{chapter}-disabling-passportauth']
//[discrete]
...
//[id='{chapter}-enabling-passportauth']
//[discrete]
...
[id='{chapter}-pointing-passportauth-to-a-datasource']
[discrete]
