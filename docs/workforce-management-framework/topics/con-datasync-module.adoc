[id='{chapter}-con-datasync-module']
...
*Datasync* is made up of two applications, the xref:{chapter}-datasync-cloud-app[Cloud App] and the xref:{chapter}-datasync-client-app[Client App].
...
[id='{chapter}-datasync-client-app']
== Datasync Client App
